...
export default function RegisterFireStation({ navigate }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#070b13] px-4 py-12 relative overflow-hidden">
      ...
      <div className="max-w-xl w-full glass-panel p-8 rounded-2xl glow-red relative z-10">
        ...
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-white flex items-center gap-2">
            <Building className="text-red-400" /> Fire Station Registration
          </h2>
          <p className="text-sm text-gray-400 mt-1">Submit your details to the Traffic Admin for verification.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-semibold uppercase tracking-wider text-gray-400 mb-2">Station Name</label>
              <input
                type="text"
                required
                value={name}
                onChange={(e) => setName(e.target.value)}
                className="w-full px-4 py-3 rounded-xl glass-input text-white focus:border-red-500"
                placeholder="Indiranagar Fire Station"
              />
            </div>
            <div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-3 rounded-xl glass-input text-white focus:border-red-500 h-20"
              placeholder="Indiranagar 100 Feet Road, Bangalore"
            />
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 px-4 rounded-xl text-white font-semibold bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-500 hover:to-rose-500 transition shadow-lg focus:outline-none"
          >
